...
2. Click on your profile in the upper-right corner of your `Dashboard` and select `Account settings` from the dropdown menu.
   ...
   ![Account settings menu](https://github.com/OrganizationDummy/devcenter/tree/acf5f40e38b6dcf6fe62e839a4c04acb31fdebd2/img/adding-a-new-app/account-settings.png)
...
4. Provide your credentials in the popup window and click `Store credentials`.
   ...
   ![Connecting Apple Developer account](https://github.com/OrganizationDummy/devcenter/tree/acf5f40e38b6dcf6fe62e839a4c04acb31fdebd2/img/adding-a-new-app/apple-dev-acc-sync.png)
